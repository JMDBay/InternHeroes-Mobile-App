...
class _EditableProfileScreenState extends State<EditableProfileScreen> {
            ...
            child: Form(
              ...
              child: Column(
                ...
                children: [
                  ...
                  buildEditableProfileItem('Phone Number', _phoneNumberController, TextInputType.phone, [
                  ...
                  buildEditableProfileItem('OJT Coordinator Email', _ojtCoordinatorEmailController, TextInputType.emailAddress, [
                    LengthLimitingTextInputFormatter(100), // Setting a limit for the email length
                  ], 'Enter a valid email address'),
                  buildEditableProfileItem('Required Hours', _requiredHoursController, TextInputType.number, null, null),
  ...
  Widget buildEditableProfileItem(String title, TextEditingController controller, TextInputType keyboardType, List<TextInputFormatter>? inputFormatters, String? errorText) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        SizedBox(height: 20),
        ...
        Container(
          ...
          child: TextFormField(
            ...
            validator: (value) {
              ...
              if (title == 'OJT Coordinator Email' && !value.contains('@')) {
                return 'The email address is badly formatted';
              }
              if (title == 'Phone Number' && value.length != 11) {
